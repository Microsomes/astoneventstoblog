...
if (isset($_GET['id']) && $_GET['id']!=null){
    $id = $_GET['id'];
    $sql = "SELECT * FROM wlv_blogs WHERE id=?";
    $stmt= $conn->prepare($sql);
    $stmt->execute([$id]);
...
<body>
 ...
 <div style="display:flex;flex-flow:column;height:100vh;overflow:hidden">
    ...
    <div class="h-96 flex items-center justify-center  text-6xl bg-blue-400 w-screen">
        ...
        <h2 class=" pointer text-white">Edit Blog?</h2>
    ...
    <div>
        ...
        <form class="p-12" action="/createBlog.php" method="POST">
            <div class="mb-4">
                ...
                <input value="<?php echo $currentBlog['title'];?>" name="title" id="title" type="text"  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Blog Title... ">
            </div> 
            ...
            <div class="mb-4">
                ...
                <textarea name="content" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="content" type="text" placeholder="Blog Title... ">
